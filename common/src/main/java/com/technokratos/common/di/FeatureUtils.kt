...
object FeatureUtils {
    ...
    private fun getHolder(context: Context): com.technokratos.common.di.FeatureContainer {
        return context.applicationContext as com.technokratos.common.di.FeatureContainer
    }
}